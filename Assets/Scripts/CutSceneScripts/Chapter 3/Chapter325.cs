...
public class Chapter325 : MonoBehaviour, CutScenes, ISaveable//Rename Class ***********************
{
    ...
    public void ForDE75()
    {
        ...
        StartCoroutine(ForDE75Coroutine());
    }
    IEnumerator ForDE75Coroutine()
    {
        yield return new WaitForSeconds(1f);
        transition.ManualTransitionOFF();
        yield return new WaitForSeconds(1f);
