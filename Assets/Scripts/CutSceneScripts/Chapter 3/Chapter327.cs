...
public class Chapter327 : MonoBehaviour, CutScenes, ISaveable//Rename Class ***********************
{
    ...
    public void ForDE04()
    {
        ...
        StartCoroutine(ForDE04Coroutine());
    }
    
    IEnumerator ForDE04Coroutine()
    {
        yield return new WaitForSeconds(1f);
        player.GetComponent<CharacterController>().enabled = false;
        SetActorStartingPosition(0, 2);
