...
public class Chapter221 : MonoBehaviour, CutScenes, ISaveable//Rename Class ***********************
{
    ...
    public void ForDE01()
    {
        ...
        MoveActor(0, 1, 0.4f);
        StartCoroutine(ForDE01Coroutine());
    }
    IEnumerator ForDE01Coroutine()
    {
    ...
    public void ChangeLocation(int actorID, int locationID, float moveSpeed)
    {
        ...
        MoveActor(actorID, locationID, moveSpeed);
    }
