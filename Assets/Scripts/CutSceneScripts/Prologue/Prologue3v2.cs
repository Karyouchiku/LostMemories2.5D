...
public class Prologue3v2 : MonoBehaviour, CutScenes, ISaveable//Rename Class ***********************
{
    ...
    public void ForDE01()
    {
        ...
        SetActorStartingPosition(10, 16);
        MoveActor(8, 2, 0.7f);
        MoveActor(9, 3, 0.7f);
        MoveActor(10, 4, 0.7f);
        for (int i = 0; i < GameObjectChildrens.Length; i++)
