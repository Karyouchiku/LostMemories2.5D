...
public class Chapter435 : MonoBehaviour, CutScenes, ISaveable//Rename Class ***********************
{
    ...
    void TransitioningToOtherPlaces(int locationID, int renderWorldID)
    {
        StartCoroutine(TransitioningToOtherPlacesCoroutine(locationID, renderWorldID));
    }
    IEnumerator TransitioningToOtherPlacesCoroutine(int locationID, int renderWorldID)
    {
        transition.ManualTransitionON();
        yield return new WaitForSeconds(1f);
        renderWorld.RenderWorlds(false, renderWorldID);
